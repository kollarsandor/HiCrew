...
def parse_args():
    ...
    # fullset  
    parser.add_argument("--data_path", default='./data/egoschema/lavila_fullset.json', type=str) 
    parser.add_argument("--anno_path", default='./data/egoschema/fullset_anno.json', type=str)  
    parser.add_argument("--duration_path", default='./data/egoschema/duration.json', type=str) 
    ...
    parser.add_argument("--api_key", default="sk-46KivuHvn6nIN1r6LlUr8B3k781oB3VaLZif2UIugY1BmqRq", type=str)
